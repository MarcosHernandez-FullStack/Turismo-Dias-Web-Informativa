...
<head>
    ...
    <link rel="stylesheet" id="elementor-post-97-css"
        href="assets/wp-content/uploads/elementor/css/post-97.css?ver=1697734203" media="all">
    ...
    <link rel="alternate" type="text/xml+oembed"
        href="./wp-json/oembed/1.0/embed/index.html?url=.%2F%2F#038;format=xml">
    ...
    <style>
        ...
        @media (max-width: 1000px) {
            .elementor-column.elementor-col-33.elementor-inner-column.elementor-element.elementor-element-5244abbf {
                width: 65%;
            }
...
<body
    class="home page-template page-template-elementor_header_footer page page-id-97 ehf-header ehf-footer ehf-template-hello-elementor ehf-stylesheet-hello-elementor jkit-color-scheme elementor-default elementor-template-full-width elementor-kit-12 elementor-page elementor-page-97">
    <div>
        ...
        <header>
            ...
            <div class="elementor elementor-177">
                ...
                <section
                    ...
                    data-id="19121f5" data-element_type="section">
                    <div class="elementor-container elementor-column-gap-default">
                        <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-422bb18f"
                            data-id="422bb18f" data-element_type="column">
                            <div class="elementor-widget-wrap elementor-element-populated">
                                <section
                                    class="elementor-section elementor-inner-section elementor-element elementor-element-1632f1f5 elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                                    data-id="1632f1f5" data-element_type="section"
                                    data-settings="{&quot;background_background&quot;:&quot;gradient&quot;}">
                                    <div class="elementor-background-overlay"></div>
                                    <div class="elementor-container elementor-column-gap-default">


                                        <img class="logo-turismo" src="assets/img/logo-light.png" alt="">
                                        <div class="elementor-column elementor-col-33 elementor-inner-column elementor-element elementor-element-5244abbf"
                                            data-id="5244abbf" data-element_type="column">
                                            <div style="background-color: white;"
                                                class="elementor-widget-wrap elementor-element-populated">
                                                <div class="elementor-element elementor-element-28318d29 elementor-widget elementor-widget-jkit_nav_menu"
                                                    data-id="28318d29" data-element_type="widget"
                                                    data-widget_type="jkit_nav_menu.default">
                                                    <div class="elementor-widget-container">
                                                        <div class="jeg-elementor-kit jkit-nav-menu break-point-tablet submenu-click-title jeg_module_97__653170c850140"
                                                            ...
                                                            <div class="jkit-menu-wrapper">
                                                                <div class="jkit-menu-container">
                                                                    <ul id="menu-menu1"
                                                                        ...
                                                                        <li id="menu-item-164"
                                                                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-164">
                                                                            <a href="{{ route('seccion.nosotros') }}">Nosotros
                                                                            </a>
                                                                        </li>
                                                                        <li id="menu-item-176"
                                                                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-176">
                                                                            <a
                                                                                href="{{ route('seccion.servicios') }}">Servicios</a>
                                                                        </li>

                                                                        <li id="menu-item-176"
                                                                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-176">
                                                                            <a
                                                                                href="{{ route('seccion.rutas') }}">Rutas</a>
                                                                        </li>
                                                                        <li id="menu-item-176"
                                                                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-176">
                                                                            <a
                                                                                href="{{ route('seccion.libro-reclamaciones') }}">Libro
                                                                                de
                                                                                Reclamaciones</a>
                                                                        </li>

                                                                        <li id="menu-item-172"
                                                                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-172">
                                                                            <a href="./pages/index.html">
                                                                                Condiciones de Viaje</a>
                                                                            <ul class="sub-menu">
                                                                                <li id="menu-item-175"
                                                                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-175">
                                                                                    <a
                                                                                        href="{{ route('seccion.preguntas-frecuentes') }}">Preguntas
                                                                                        y Respuestas</a>
                                                                                </li>
                                                                                <li id="menu-item-174"
                                                                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-174">
                                                                                    <a
                                                                                        href="{{ route('seccion.calendario-eventos') }}">Calendario
                                                                                        de Eventos</a>
                                                                                </li>
                                                                                <li id="menu-item-173"
                                                                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-173">
                                                                                    <a
                                                                                        href="{{ route('seccion.terminos-condiciones') }}">Términos
                                                                                        y Condiciones</a>
                                                                                </li>
                                                                            </ul>
                                                                        </li>
                                                                ...
                                                                <div class="jkit-nav-identity-panel">
                                                                    <div class="jkit-nav-site-title"><a
                                                                            ...
                                                                            class="jkit-nav-logo"><img
                                                                                style="width: 70%"
                                                                                src="assets/img/logo-light.png"></a>
                                                                    </div>
                                                                    <button class="jkit-close-menu"><i
                                                                            aria-hidden="true"
                                        ...
                                        <div style="background:linear-gradient(to right, #0da40d 0%, #017F01 100%)"
                                            class="elementor-column elementor-col-33 elementor-inner-column elementor-element elementor-element-6050e1fb elementor-hidden-tablet elementor-hidden-mobile"
                                            data-id="6050e1fb" data-element_type="column"
                                            data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                                            <div class="elementor-widget-wrap elementor-element-populated">
                                                <div class="elementor-element elementor-element-4e45304f elementor-view-stacked elementor-widget__width-auto elementor-absolute elementor-shape-circle elementor-widget elementor-widget-icon"
                                                    data-id="4e45304f" data-element_type="widget"
                                                    data-settings="{&quot;_position&quot;:&quot;absolute&quot;}"
                                                    data-widget_type="icon.default">
                                                    <div class="elementor-widget-container">
                                                        <div class="elementor-icon-wrapper">
                                                            <div style="margin-top: -10px; background-color: #0da40d;"
                                                ...
                                                <div class=" contacto-header elementor-element elementor-element-500482b6 elementor-widget__width-auto jkit-equal-height-disable elementor-widget elementor-widget-jkit_icon_box"
                                                    data-id="500482b6" data-element_type="widget"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="jkit-icon-box-wrapper hover-from-left">
                                                                    <div class="icon-box icon-box-body">
                                                                        ...
                                                                        <p class="icon-box-description">(+62) 81587
                                                                            6218
                                                                        </p>
                                                                    </div>
        ...
        <div class="footer-width-fixer">
            <div data-elementor-type="wp-post" data-elementor-id="232" class="elementor elementor-232">
                <section style="background-color: #0b4044"
                    ...
                    <div class="elementor-background-overlay"></div>
                    <div class="elementor-container elementor-column-gap-default">
                        <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-18c74661"
                            data-id="18c74661" data-element_type="column">
                            <div class="elementor-widget-wrap elementor-element-populated">
                                <section
                                    class="elementor-section elementor-inner-section elementor-element elementor-element-18367562 elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                                    data-id="18367562" data-element_type="section">
                                    <div class="elementor-container elementor-column-gap-no">
                                        <div class="elementor-column elementor-col-25 elementor-inner-column elementor-element elementor-element-1fde75da"
                                            ...
                                            <div class="elementor-widget-wrap elementor-element-populated">
                                                ...
                                                <div
                                                    ...
                                                    <div class="elementor-widget-container">
                                                        Viaja por todo el Norte y Nororiente de nuestro pais con
                                                        Turismo Dias </div>
                                                </div>
                                        ...
                                        <div class="elementor-column elementor-col-25 elementor-inner-column elementor-element elementor-element-394ac84c"
                                            data-id="394ac84c" data-element_type="column">
                                            <div class="elementor-widget-wrap elementor-element-populated">
                                                <div class="elementor-element elementor-element-157a0348 elementor-widget elementor-widget-heading"
                                                    data-id="157a0348" data-element_type="widget"
                                                ...
                                                <div class="elementor-element elementor-element-3350f6c6 elementor-icon-list--layout-traditional elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list"
                                                    data-id="3350f6c6" data-element_type="widget"
                                                        ...
                                                        <ul class="elementor-icon-list-items">
                                                            ...
                                                            <li class="elementor-icon-list-item">
                                                                <a href="{{ route('seccion.libro-reclamaciones') }}">
                                                                    ...
                                                                    <span class="elementor-icon-list-text">Libro de
                                                                        Reclamaciones</span>
                                                                </a>
                                                            </li>
                                                            <li class="elementor-icon-list-item">
                                                                <a href="{{ route('seccion.preguntas-frecuentes') }}">
                                                                    ...
                                                                    <span class="elementor-icon-list-text">Preguntas
                                                                        Frecuentes</span>
                                                                </a>
                                                            </li>
                                                        </ul>
                                        ...
                                        <div class="elementor-column elementor-col-25 elementor-inner-column elementor-element elementor-element-68d4a2c3"
                                            data-id="68d4a2c3" data-element_type="column">
                                            <div class="elementor-widget-wrap elementor-element-populated">
                                                <div class="elementor-element elementor-element-588078c elementor-widget elementor-widget-heading"
                                                    data-id="588078c" data-element_type="widget"
                                                    data-widget_type="heading.default">
                                                    <div class="elementor-widget-container">
                                                        <h4 class="elementor-heading-title elementor-size-default">
                                                            Contacto</h4>
                                                ...
                                                <div class="elementor-element elementor-element-16c9aa29 elementor-icon-list--layout-traditional elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list"
                                                    data-id="16c9aa29" data-element_type="widget"
                                                    data-widget_type="icon-list.default">
                                                    <div class="elementor-widget-container">
                                                        <ul class="elementor-icon-list-items">
                                                            <li class="elementor-icon-list-item">
                                                            ...
                                                            <li class="elementor-icon-list-item">
                                                                ...
                                                                <span class="elementor-icon-list-text">(+62)81587
                                                                    6218</span>
                                                            </li>
                                                            <li class="elementor-icon-list-item">
                                                                <span class="elementor-icon-list-icon">
                                        ...
                                        <div class="elementor-column elementor-col-25 elementor-inner-column elementor-element elementor-element-75f1b499"
                                            data-id="75f1b499" data-element_type="column">
                                            <div class="elementor-widget-wrap elementor-element-populated">
                                                <div class="elementor-element elementor-element-4c1e42cb elementor-widget elementor-widget-heading"
                                                    data-id="4c1e42cb" data-element_type="widget"
                                                    data-widget_type="heading.default">
                                                    <div class="elementor-widget-container">
                                                        <h4 class="elementor-heading-title elementor-size-default">
                                                            Condiciones</h4>
                                                ...
                                                <div
                                                    class="elementor-element elementor-element-1e735548 elementor-widget elementor-widget-text-editor">
                                ...
                                <section
                                    class="elementor-section elementor-inner-section elementor-element elementor-element-486b8d88 elementor-section-content-middle elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                                    data-id="486b8d88" data-element_type="section">
                                    <div class="elementor-container elementor-column-gap-no">
                                        <div class="elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-7e3eff6a"
                                            data-id="7e3eff6a" data-element_type="column">
                                            <div class="elementor-widget-wrap elementor-element-populated">
                                                <div
                                        ...
                                        <div class="elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-ef67422"
                                            data-id="ef67422" data-element_type="column">
                                            <div class="elementor-widget-wrap elementor-element-populated">
                                                <div
                                                    class="elementor-element elementor-element-74850dd3 elementor-widget elementor-widget-text-editor">
                                                    <div class="elementor-widget-container">
                                                        Copyright Turismo Dias © 2023. Todos los derechos
                                                        reservados. </div>
                                                </div>
                                            </div>
                                        </div>
