                                            ...
                                            <div class="grupo-contenedor">
                                                <div class="grupo-item">
                                                    ...
                                                    <select id="opciones"
                                                        ...
                                                        <option style="color: #9e9c9c;" value="opcion1">Producto</option>
                                                        <option selected style="color: #9e9c9c;" value="opcion2">Servicio
                                                        </option>
                                                    </select>
                                        ...
                                        <div class="grupo-form">
                                            <div class="grupo-contenedor">
                                                <div class="grupo-item">
                                                    ...
                                                    <select id="opciones"
                                                        style=" border: 0.5px solid #ccc; opacity: 0.5; border-radius: 5px;">
                                                        <option style="color: #9e9c9c;" value="opcion1">Reclamo</option>
                                                        <option selected style="color: #9e9c9c;" value="opcion2">Queja
                                                        </option>
                                                    </select>
